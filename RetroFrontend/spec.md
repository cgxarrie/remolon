...
# Users
Ability to login and register users, with different roles (Manager, StandardUser). Managers can manage retrospectives and users, and StandardUsers can participate in retrospectives.
Managers can change any user's role inside their organization to Manager or StandardUser.
...
Restrospectives can be created, edited, and deleted by Managers. When a retrospective is created, the user creating it is automatically assigned to it.

When a retrospective is closed, all items are locked and cannot be edited or deleted. Only Managers can close a retrospective.

When a retrospective is closed, the user who closed it is recorded in the database.


# Items
Items can be created, edited, and deleted by Managers. StandardUsers can only edit or delete items created by themselves. 
